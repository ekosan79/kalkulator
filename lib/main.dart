...
import 'package:kalkulator/splase.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        '/home': (BuildContext context) => SimpelKalulator(),
      },
    );
  }
}

class SimpelKalulator extends StatefulWidget {
  @override
  _SimpelKalulatorState createState() => _SimpelKalulatorState();
}

class _SimpelKalulatorState extends State<SimpelKalulator> {
  String equation = "0";
  String result = "0";
  String expression = "";
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Table(
                  children: [
                    TableRow(
                      children: [buildButton("×", 1, Colors.greenAccent)],
                    ),
                    TableRow(
                      children: [buildButton("-", 1, Colors.greenAccent)],
                    ),
